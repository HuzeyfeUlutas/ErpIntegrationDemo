    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EmployeeNo = table.Column<decimal>(type: "numeric", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PersonnelsId = table.Column<Guid>(type: "uuid", nullable: false),
                    RolesId = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonnelRoles", x => new { x.PersonnelsId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_PersonnelRoles_Personnels_PersonnelsId",
                        column: x => x.PersonnelsId,
                        principalTable: "Personnels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonnelRoles_Roles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RuleRoles", x => new { x.RolesId, x.RulesId });
                    table.ForeignKey(
                        name: "FK_RuleRoles_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RuleRoles_Rules_RulesId",
                        column: x => x.RulesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonnelRoles_RolesId",
                table: "PersonnelRoles",
                column: "RolesId");

            migrationBuilder.CreateIndex(
                name: "IX_Personnels_EmployeeNo",
                table: "Personnels",
                column: "EmployeeNo",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RuleRoles_RulesId",
                table: "RuleRoles",
                column: "RulesId");

            migrationBuilder.CreateIndex(
                name: "IX_Rules_Campus_Title",
                table: "Rules",
                columns: new[] { "Campus", "Title" });
            
            migrationBuilder.Sql("""
                                 CREATE UNIQUE INDEX IF NOT EXISTS ux_rules_scope
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""DROP INDEX IF EXISTS ux_rules_scope;""");
        }
    }
}
